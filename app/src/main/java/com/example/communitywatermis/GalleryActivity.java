...
public class GalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slideModels.add(new SlideModel("https://www.nairobiwater.co.ke/components/com_eventgallery/helpers/image.php?option=com_eventgallery&mode=full&view=resizeimage&folder=Facilities&file=1.JPG","Water purification facility"));
        slideModels.add(new SlideModel("https://www.nairobiwater.co.ke/components/com_eventgallery/helpers/image.php?option=com_eventgallery&mode=full&view=resizeimage&folder=Facilities&file=10.jpg","Dam"));
        slideModels.add(new SlideModel("https://www.nairobiwater.co.ke/components/com_eventgallery/helpers/image.php?option=com_eventgallery&mode=full&view=resizeimage&folder=Facilities&file=8.JPG","Water storage for unpurified water"));
        slideModels.add(new SlideModel("https://www.nairobiwater.co.ke/components/com_eventgallery/helpers/image.php?option=com_eventgallery&mode=full&view=resizeimage&folder=Facilities&file=7.JPG","Filtration site"));
        slideModels.add(new SlideModel("https://www.nairobiwater.co.ke/components/com_eventgallery/helpers/image.php?option=com_eventgallery&mode=full&view=resizeimage&folder=Facilities&file=5.JPG","Water storage for purified water"));
